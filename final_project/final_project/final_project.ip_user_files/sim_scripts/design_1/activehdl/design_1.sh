...
#
# Script generated by Vivado on Thu May 07 23:12:10 -0600 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/jakem/ece383_wksp/final_project/final_project/final_project.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
